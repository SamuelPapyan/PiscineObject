...
/*                                                +#+#+#+#+#+   +#+           */
/*   Created: 2025/08/10 23:21:19 by spapyan           #+#    #+#             */
/*   Updated: 2025/08/10 23:21:19 by spapyan          ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
int main(void)
{
    ...
    std::cout << "Getting third account with id: " << acc3.get_id() << ", amount: " << acc3.get_value();
    std::cout << "\n";
